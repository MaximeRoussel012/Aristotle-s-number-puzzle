...
//5 conditions lignes
  ...
  A(12,16) = 1;  A(4,17) = 1;  A(4,18) = 1; 
//5 conditions diagonnales "/"
...
//5 conditions diagonnales"\"
  ...
  A(14,7) = 1;  A(14,12) = 1;  A(15,16) = 1; 

  
 //code pour vérifier que la matrice A est de rang 12 et donc que 3 conditions sont dépendantes linéairement aux autres 
 // Il faudra imposer 7 conditions afin de resoudre X=A^(-1)B.
